...
function success_fine() {
	Lobibox.notify('success', {
		pauseDelayOnHover: true,
		continueDelayOnInactiveTab: false,
		position: 'top right',
		icon: 'bx bx-check-circle',
		msg: 'Fine has been added successfully to the database!'
	});
}

function success_delete_code() {
	Lobibox.notify('success', {
		pauseDelayOnHover: true,
		continueDelayOnInactiveTab: false,
		position: 'top right',
		icon: 'bx bx-check-circle',
		msg: '10 code has been successfully deleted from the database!'
	});
}
...
function success_load() {
	Lobibox.notify('success', {
		...
		position: 'top right',
		icon: 'bx bx-check-circle',
		msg: 'Data has been refreshed and loaded successfully!'
	});
}
...
function success_code() {
	Lobibox.notify('success', {
		...
		position: 'top right',
		icon: 'bx bx-check-circle',
		msg: 'Ten code has been added successfully to the database!'
	});
}
